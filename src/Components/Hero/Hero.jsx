...
export default function Hero() {
  ...
  return (
    <>
      <div className=''>
        <div className="px-5 lg:px-14 max-w-screen-2xl mx-auto min-h-screen h-screen">
            ...
            <div className=" flex flex-col md:flex-row-reverse items-center justify-between gap-8 md:gap-12">
              ...
              <div className="w-full md:w-2/2 text-center md:text-left">
                <h1 className="text-4xl md:text-5xl text-blue-950 font-bold mb-4 leading-tight">
                  ...
                  <span className="text-lime-500 block  sm:inline"> from 8 Years</span>
                </h1>
                <p className="text-base md:text-xl text-gray-600    mb-7 md:mb-6">
                  Unlock The Potential Of Real Estate By Learning The Market And Investment Strategies.
                </p>
                <button className="px-6 py-2 font-semibold sm:px-7 sm:py-3 bg-green-500 text-white rounded 
           transition-all duration-300 transform hover:-translate-y-1" onClick={handleNavigate}>
                  Learn More
                </button>
              </div>
            </div>
            ...
            <div className=" flex flex-col md:flex-row-reverse items-center justify-between gap-5 md:gap-12">
              ...
              <div className="w-full md:w-2/2 text-center md:text-left">
                <h1 className="text-4xl text-blue-950 sm:text-4xl md:text-5xl font-bold mb-3 leading-tight">
                  ...
                  <span className="text-lime-500 block sm:inline"> In 4 Months</span>
                </h1>
                <p className="text-base text-gray-600 md:text-xl   mb-7 md:mb-5">
                Real estate offers a powerful way to grow your wealth. By learning the basics of the market.                </p>
                <button className="px-6 py-2 font-semibold sm:px-7 sm:py-3 bg-green-500 text-white rounded 
           transition-all duration-300 transform hover:-translate-y-1" onClick={handleNavigate}>
                  Learn More 
                </button>
